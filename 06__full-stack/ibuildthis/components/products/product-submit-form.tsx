...
export default function ProductSubmitForm() {
  ...
  return (
    <form className="space-y-6" action={formAction}>
      {message && (
        <div className={cn("p-4 border rounded-lg", success ? "bg-primary/10 border-primary text-primary" : "bg-destructive/10 border-destructive text-destructive")}> {message} </div>
      )}
