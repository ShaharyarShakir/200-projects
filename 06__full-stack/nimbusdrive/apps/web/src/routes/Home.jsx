...
import { 
  Cloud, HardDrive, Database, Shield, ArrowRight, CheckCircle2, 
  UploadCloud, Play, Zap, FileText, ChevronRight, Activity, Terminal
} from "lucide-react";
    ...
    <div className="space-y-24 pb-20 text-slate-800 dark:text-slate-200 animate-fade-in">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-base md:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
              Nimbus Drive connects directly to your private S3 storage cluster. Manage files, view real-time gateway status, and render instant previews. Fully powered by React, Vite, Express, and Garage.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              {token ? (
                ...
                <>
                  ...
                  <Link to="/login">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto font-bold border-teal-500/20 text-teal-600 dark:text-teal-400 hover:bg-teal-50 dark:hover:bg-teal-950/20">
                      Login to Node
                    </Button>
                  </Link>
                </>
            ...
            <div className="pt-6 border-t border-slate-200/60 dark:border-slate-800/60 grid grid-cols-3 gap-6 max-w-md mx-auto lg:mx-0">
              ...
              <div>
                <span className="block text-2xl font-bold text-slate-900 dark:text-white font-mono">99.9%</span>
                <span className="text-xs text-slate-400">Node Sync SLA</span>
              </div>
              <div>
                <span className="block text-2xl font-bold text-slate-900 dark:text-white font-mono">5 GB</span>
              ...
              <div className="h-64 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-150 dark:border-slate-900 p-5 flex flex-col justify-between">
                {activeMockTab === "storage" ? (
                  <div className="space-y-5 flex-1">
                    <div className="space-y-2">
                      <div className="flex justify-between items-center text-xs font-semibold">
                        <span className="text-slate-500 dark:text-slate-400">Bucket: nimbus-drive</span>
                    ...
                    <div className="space-y-2.5">
                      <div className="flex justify-between items-center bg-white dark:bg-[#0b0f0e]/60 p-2.5 border border-slate-100 dark:border-slate-900 rounded-xl">
                        <div className="flex items-center gap-2 truncate">
                          ...
                          <span className="text-xs font-medium truncate max-w-[200px]">cluster_backup_2026.tar.gz</span>
                        </div>
                      ...
                      <div className="flex justify-between items-center bg-white dark:bg-[#0b0f0e]/60 p-2.5 border border-slate-100 dark:border-slate-900 rounded-xl">
                        <div className="flex items-center gap-2 truncate">
                          ...
                          <span className="text-xs font-medium truncate max-w-[200px]">system_metrics.json</span>
                        </div>
                  ...
                  <div className="font-mono text-[10px] text-emerald-400 space-y-1.5 overflow-auto flex-1 text-left">
                    ...
                    <p className="text-emerald-400 font-bold">[21:01:06] S3 Gateway mapping active at localhost:3900</p>
                    <p className="text-teal-400">[21:02:14] GET /api/files/6a735b.../preview 200 OK (32ms)</p>
                    <p className="text-slate-500">[21:04:12] Bucket replication check: 0 changes detected</p>
                  </div>
                )}
                ...
                <div className="flex justify-between items-center border-t border-slate-100 dark:border-slate-900 pt-3 text-xs text-slate-400">
                  <span className="flex items-center gap-1.5"><Terminal className="w-3.5 h-3.5 text-slate-500" /> node-s3-garage-east</span>
      ...
      <section className="max-w-6xl mx-auto px-4">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">Built for Private Cloud Deployments</h2>
          <p className="text-slate-500 dark:text-slate-400">Nimbus Drive brings advanced enterprise file storage features straight to your self-hosted setup.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
          ...
          <Card className="hover:scale-[1.03] transition-all duration-300 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b0f0e]/40 p-6 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Garage S3 API</h3>
              <p className="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">
                Connects straight to your dxflrs/garage S3 node. High performance distributed object storage.
              </p>
            </div>
          </Card>
          ...
          <Card className="hover:scale-[1.03] transition-all duration-300 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b0f0e]/40 p-6 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">MongoDB Metadata</h3>
              <p className="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">
                Indexes document metadata instantly, facilitating instant searches, custom naming, and star filters.
              </p>
            </div>
          </Card>
          ...
          <Card className="hover:scale-[1.03] transition-all duration-300 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b0f0e]/40 p-6 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Streaming Previews</h3>
              <p className="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">
                Instantly streams images, video, audio, code, and PDFs in-app. Fully authenticated via token parameters.
              </p>
            </div>
          </Card>
          ...
          <Card className="hover:scale-[1.03] transition-all duration-300 border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0b0f0e]/40 p-6 flex flex-col justify-between">
            <div>
              ...
              <h3 className="text-lg font-bold text-slate-900 dark:text-white mb-2">Secure Gateway</h3>
              <p className="text-slate-500 dark:text-slate-400 text-xs leading-relaxed">
                Custom helmet headers prevent same-origin blocking. Fully sandboxed file security pipelines.
              </p>
            </div>
          </Card>
        </div>
      ...
      <section className="max-w-4xl mx-auto px-4 border border-slate-200 dark:border-slate-800/85 bg-white dark:bg-[#0b0f0e]/30 rounded-3xl p-8 md:p-12 relative overflow-hidden text-center space-y-8">
        ...
        <div className="space-y-3">
          <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 dark:text-white">Seamless Object Pipetree</h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-12 relative z-10 pt-4">
          <div className="space-y-2">
            ...
            <span className="block text-sm font-semibold text-slate-700 dark:text-slate-200">React Client</span>
          ...
          <div className="space-y-2">
            ...
            <span className="block text-sm font-semibold text-slate-700 dark:text-slate-200">Express API Node</span>
          ...
          <div className="space-y-2">
            ...
            <span className="block text-sm font-semibold text-slate-700 dark:text-slate-200">Garage S3 Cluster</span>
      ...
      <section className="text-center max-w-xl mx-auto space-y-6 px-4">
        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white">Ready to Host Your Files?</h2>
        <p className="text-slate-500 dark:text-slate-400 text-sm">
          Connect to your S3 cluster in less than a minute. Secure, scalable, and fully controlled by you.
        </p>
        <Link to="/register">
