...
// Keep form synced if academy updates
...
<template>
  <div class="max-w-6xl space-y-8">
    <div>
      <h1 class="text-2xl font-bold text-white tracking-tight">Academy Branding</h1>
      <p class="text-slate-400 text-sm mt-1">
        Customize the public appearance, colors, and identity of your academy website.
      </p>
    </div>
