...
-- CreateIndex
CREATE UNIQUE INDEX "event_invite_event_id_key" ON "event_invite"("event_id");

-- CreateIndex
CREATE UNIQUE INDEX "event_invite_token_key" ON "event_invite"("token");
...
-- AddForeignKey
ALTER TABLE "event_invite" ADD CONSTRAINT "event_invite_event_id_fkey" FOREIGN KEY ("event_id") REFERENCES "events"("id") ON DELETE CASCADE ON UPDATE CASCADE;
