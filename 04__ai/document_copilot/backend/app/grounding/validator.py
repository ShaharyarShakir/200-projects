...
class GoogleGroundingJudge:
    ...
    def _judge_sync(
        ...
        response = self._client.chat.completions.create(
            model=settings.google_grounding_model,
            temperature=0,
            messages=[
        ...
        parsed = CitationGroundingDecisionList.model_validate_json(raw)
...
class GroundingValidator:
    ...
    async def validate(
        ...
        try:
            judge = self._judge or GoogleGroundingJudge()
